...
4. Optionally set `strategy`, `seed`, `ref`, `max_series`, and `request_delay`
   ...
   - `seed` can be a MangaUpdates series ID or manga title to anchor the Atlas around one series
...
- You can optionally set a seed manga title or MangaUpdates series ID to anchor the Atlas build
