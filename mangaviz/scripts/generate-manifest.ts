...
const m = { version:'1.0.0', buildDate:new Date().toISOString(), strategy, seriesCount:sourceSeriesCount, totalNodes:tn, totalEdges:te, shards:{nodes:ns,edges:es,positions:['positions.json'],clusters:['clusters.json']}, searchIndex:'search-index.json' };
