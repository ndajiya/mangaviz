...
const SP:React.FC<Props>=({stats,visible,onToggle})=>{
  ...
  return<div className={"stats-panel"+(visible?' visible':' stats-panel--collapsed')}>
  <div className="stats-header">
    <h3>Statistics</h3>
    <button
      type="button"
      className="stats-action-btn"
      aria-label={visible ? "Minimize statistics" : "Expand statistics"}
  ...
  {visible?<div className="stats-content">
