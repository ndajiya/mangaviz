...
const SERIES: any[] = [
  { id: 1, title: 'Berserk', type: 'Manga', year: '1989', rating: 9.3, votes: 150000, status: 'Ongoing', desc: 'Guts, the Black Swordsman, seeks revenge against his former friend Griffith in a dark medieval fantasy world.', genres: ['Action', 'Adventure', 'Dark Fantasy', 'Drama', 'Horror', 'Supernatural'], cats: ['Seinen', 'Mature', 'Violence', 'Gore'], authors: ['Kentaro Miura'], artists: ['Kentaro Miura'], pubs: ['Hakusensha'], mags: ['Young Animal'], recs: [[3,'Vinland Saga',95],[5,'Attack on Titan',80],[7,'Vagabond',90],[12,'Claymore',75]], rels: [] },
  { id: 2, title: 'One Piece', type: 'Manga', year: '1997', rating: 9.0, votes: 200000, status: 'Ongoing', desc: 'Monkey D. Luffy sets sail to find the legendary One Piece treasure and become Pirate King.', genres: ['Action', 'Adventure', 'Comedy', 'Drama', 'Fantasy', 'Shounen'], cats: ['Shounen', 'Adventure', 'Pirates', 'Superpowers'], authors: ['Eiichiro Oda'], artists: ['Eiichiro Oda'], pubs: ['Shueisha'], mags: ['Weekly Shonen Jump'], recs: [[4,'Naruto',85],[6,'Bleach',75],[8,'Hunter x Hunter',80],[9,'Dragon Ball',70]], rels: [] },
  ...
  { id: 10, title: 'Death Note', type: 'Manga', year: '2003', rating: 8.9, votes: 160000, status: 'Completed', desc: 'A high school student gains the power to kill anyone by writing their name in a notebook.', genres: ['Mystery', 'Psychological', 'Supernatural', 'Thriller', 'Shounen'], cats: ['Shounen', 'Psychological', 'Detective', 'Supernatural'], authors: ['Tsugumi Ohba'], artists: ['Takeshi Obata'], pubs: ['Shueisha'], mags: ['Weekly Shonen Jump'], recs: [[5,'Attack on Titan',65],[109,'Monster',75],[110,'Code Geass',70]], rels: [] },
  { id: 11, title: 'My Hero Academia', type: 'Manga', year: '2014', rating: 8.5, votes: 130000, status: 'Ongoing', desc: 'A boy born without superpowers dreams of becoming the greatest hero.', genres: ['Action', 'Comedy', 'Superhero', 'School', 'Shounen'], cats: ['Shounen', 'Superheroes', 'School', 'Superpowers'], authors: ['Kohei Horikoshi'], artists: ['Kohei Horikoshi'], pubs: ['Shueisha'], mags: ['Weekly Shonen Jump'], recs: [[4,'Naruto',70],[2,'One Piece',65],[6,'Bleach',65]], rels: [] },
  { id: 12, title: 'Claymore', type: 'Manga', year: '2001', rating: 8.4, votes: 60000, status: 'Completed', desc: 'Half-human, half-monster Claymores hunt man-eating Yoma.', genres: ['Action', 'Dark Fantasy', 'Drama', 'Horror', 'Supernatural'], cats: ['Seinen', 'Dark Fantasy', 'Swords', 'Female Lead'], authors: ['Norihiro Yagi'], artists: ['Norihiro Yagi'], pubs: ['Shueisha'], mags: ['Monthly Shonen Jump'], recs: [[1,'Berserk',75],[5,'Attack on Titan',65]], rels: [] },
  { id: 105, title: 'Lone Wolf and Cub', type: 'Manga', year: '1970', rating: 9.0, votes: 40000, status: 'Completed', desc: 'A ronin and his young son travel feudal Japan.', genres: ['Action', 'Drama', 'Historical', 'Samurai', 'Seinen'], cats: ['Seinen', 'Samurai', 'Historical'], authors: ['Kazuo Koike'], artists: ['Goseki Kojima'], pubs: ['Kodansha'], mags: ['Weekly Post'], recs: [], rels: [] },
  { id: 106, title: 'Yu Yu Hakusho', type: 'Manga', year: '1990', rating: 8.6, votes: 70000, status: 'Completed', desc: 'A teenage delinquent becomes a Spirit Detective.', genres: ['Action', 'Adventure', 'Comedy', 'Fantasy', 'Martial Arts', 'Shounen'], cats: ['Shounen', 'Spirits', 'Tournament'], authors: ['Yoshihiro Togashi'], artists: ['Yoshihiro Togashi'], pubs: ['Shueisha'], mags: ['Weekly Shonen Jump'], recs: [], rels: [] },
  { id: 109, title: 'Monster', type: 'Manga', year: '1994', rating: 9.1, votes: 85000, status: 'Completed', desc: 'A neurosurgeon hunts a former patient turned serial killer.', genres: ['Drama', 'Horror', 'Mystery', 'Psychological', 'Thriller', 'Seinen'], cats: ['Seinen', 'Psychological', 'Medical', 'Conspiracy'], authors: ['Naoki Urasawa'], artists: ['Naoki Urasawa'], pubs: ['Shogakukan'], mags: ['Big Comic Original'], recs: [], rels: [] },
  { id: 110, title: 'Code Geass', type: 'Manga', year: '2006', rating: 8.7, votes: 95000, status: 'Completed', desc: 'A prince gains the power of absolute obedience and leads a rebellion.', genres: ['Action', 'Drama', 'Mecha', 'Psychological', 'Sci-Fi', 'Shounen'], cats: ['Shounen', 'Mecha', 'Psychological', 'Strategy'], authors: ['Goro Taniguchi', 'Ichiro Okouchi'], artists: ['Majiko!'], pubs: ['Kadokawa Shoten'], mags: ['Monthly Asuka'], recs: [], rels: [] },
  { id: 112, title: 'Solo Leveling', type: 'Manhwa', year: '2018', rating: 8.9, votes: 110000, status: 'Completed', desc: 'The weakest hunter gains a unique leveling power.', genres: ['Action', 'Adventure', 'Fantasy', 'Supernatural', 'Dungeon'], cats: ['Manhwa', 'Webtoon', 'System', 'Leveling'], authors: ['Chugong'], artists: ['DUBU'], pubs: ['Kakaopage'], mags: ['KakaoWebtoon'], recs: [[113,'The Beginning After The End',75],[115,'Omniscient Reader',70]], rels: [] },
...
async function main() {
  ...
  function addNode(id: string, label: string, type: string, weight = 1, meta?: any, sm?: any) {
    if (!nodeMap.has(id)) nodeMap.set(id, { id, label, type, weight, metadata: meta || {}, seriesMetadata: sm });
  ...
  for (const s of SERIES) {
    ...
    const assoc = { authors: s.authors.map((n:string) => ({name:n})), artists: s.artists.map((n:string) => ({name:n})), publishers: s.pubs.map((n:string) => ({name:n})), publications: s.mags.map((n:string) => ({name:n})), genres: s.genres.map((n:string) => ({name:n,slug:slugify(n)})), categories: s.cats.map((n:string) => ({name:n,slug:slugify(n)})) };
    const sm = { seriesId: s.id, type: s.type, year: s.year, rating: s.rating, ratingVotes: s.votes, url: `https://www.mangaupdates.com/series.html?id=${s.id}`, status: s.status, description: s.desc, associated: assoc, recommendations: s.recs.map((r:any) => ({title:r[1],id:r[0],weight:r[2]})), relatedSeries: s.rels };
  ...
  console.log(`Generated demo data: ${nodeMap.size} nodes, ${edges.length} edges, ${byType.series?.length||0} series`);
}
